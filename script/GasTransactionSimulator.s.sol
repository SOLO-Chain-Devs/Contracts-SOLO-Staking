        ...
        for (uint256 i = 0; i < scenario.users.length; i++) {
            ...
            console.log(
                string.concat(
                    ...
                    "| ",
                    vm.toString(actual / 100),
                    ".",
                    vm.toString((actual % 100) / 10),
                    vm.toString(actual % 10),
                    "%",
                    actual < 1000 ? "   " : "  ",
                    "| ",
                    vm.toString(comparative / 100),
                    ".",
                    vm.toString((comparative % 100) / 10),
                    vm.toString(comparative % 10),
                    "%",
                    comparative < 1000 ? "       " : "      ",
                    "|"
                )
        ...
        for (uint256 i = 0; i < scenario.users.length; i++) {
            ...
            console.log(
                string.concat(
                    ...
                    "| ",
                    vm.toString(user.multiplier / 100),
                    ".",
                    vm.toString(user.multiplier % 100 / 10),
                    "x",
                    "       | ",
    ...
    function simulateGasUsage(ScenarioData memory scenario) internal {
        ...
        for (uint256 i = 0; i < scenario.users.length; i++) {
            ...
            console.log(
                string.concat(
                    "User ",
                    string(abi.encodePacked(bytes1(uint8(65 + i)))),
                    " (",
                    user.tier,
                    ") used gas with ",
